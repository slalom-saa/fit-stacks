...
namespace Slalom.Stacks.Messaging
{
    ...
    public abstract class UseCaseActor<TCommand> : IHandle<TCommand> where TCommand : Command
    {
        ...
        public virtual void Execute(TCommand message)
        {
        ...
        public virtual Task ExecuteAsync(TCommand message)
        {
        ...
        public async Task<object> Handle(MessageEnvelope instance)
        {
            ...
            await this.ExecuteAsync((TCommand)instance.Message);
    ...
    /// <summary>
    /// Defines an event actor that performs a defined function.
    /// </summary>
    /// <typeparam name="TEvent">The type of command.</typeparam>
    public abstract class EventActor<TEvent> : IHandle<TEvent> where TEvent : IEvent
    {
        private IDomainFacade _domain;
