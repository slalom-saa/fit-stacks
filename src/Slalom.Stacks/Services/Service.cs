...
namespace Slalom.Stacks.Services
{
    ...
    public abstract class Service<TCommand, TResult> : Service<TCommand>, IHandle<TCommand> where TCommand : class
    {
        /// <summary>
    ...
    public abstract class Service<TCommand> : Service, IHandle<TCommand> where TCommand : class
    {
        /// <summary>
